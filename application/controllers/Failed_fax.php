...
class Failed_fax extends CI_Controller {
	...
	function __construct(){
			...
			$this->load->model('Failed_faxModel');
		}
		...
		$result['fail_data'] = $this->Failed_faxModel->getfailed();
			$this->load->view('failed_fax',$result);
		}

		public function delete($id)
		{
			$result = $this->Failed_faxModel->delete($id);
			echo $result;
			redirect(base_url().'Failed_Fax');
		}
	}
