...
$this->load->model('Sent_mailModel');
...

	{
		...
		$result['sent_mail'] = $this->Sent_mailModel->getsentmail();

		$this->load->view('sent_mail',$result);

	}

		public function get_email($id){
		$result = $this->Sent_mailModel->get_email($id);
		echo json_encode($result);
	}

	public function delete($id){
		$result = $this->Sent_mailModel->delete($id);
		redirect(base_url().'Fax_Outbox');
