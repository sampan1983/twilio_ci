...
class Sent_fax extends CI_Controller {
	...
	function __construct(){
		...
		$result['data_get'] = $this->Sent_faxModel->getdata();
			$this->load->view('sent_fax',$result);
		}

		public function delete($id)
		{
			$result = $this->Sent_faxModel->delete($id);
			print_r($result);
