            ...
            <div class="col-lg-12">
              ...
              <div class="card">
                ...
                <div class="card-body col-lg-7">
                  ...
                  <form class="form-horizontal" id="formValidate2" data-validate="parsley" method="post" name="client_record" enctype="multipart/form-data" novalidate>
    ...
    $.ajax({
          ...
          success:function(r)
          {
            ...
            if (r)
            {
              ...
              var copilot = '<option value = "'+r[i].copilet_msg_service_id+'"  selected>Copilot</option>';
              }
          }
          else
          {
